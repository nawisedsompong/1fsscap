...
module.exports = async(srv) => {
	...
	async function getSMSReplicationClaims(req, table, dateRange) {
		...
		let result = await tx.run(
			...
			ON "CLAIM_LINEITEM"."PARENT_CLAIM_REFERENCE" = "CLAIM_MASTER"."CLAIM_REFERENCE" AND "CLAIM_MASTER"."CLAIM_STATUS"='Approved' AND "CLAIM_LINEITEM"."CLAIM_CODE" != 'PUCLAW' AND "CLAIM_LINEITEM"."CLAIM_CODE" != 'PURCOD'
